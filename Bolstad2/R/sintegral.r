...
sintegral <- function(x, fx, n.pts = 256) {
    ## numerically integrates fx over x using Simpsons rule x - a sequence of x values fx - the value of the function to be integrated at x n.pts - the number of points to be
